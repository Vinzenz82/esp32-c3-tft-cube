...
// #define CONFIG_ESP_FTM_REPORT_SHOW_DIAG
// #define CONFIG_ESP_FTM_REPORT_SHOW_RTT
// #define CONFIG_ESP_FTM_REPORT_SHOW_T1T2T3T4
// #define CONFIG_ESP_FTM_REPORT_SHOW_RSSI
